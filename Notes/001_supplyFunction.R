...
source("./Notes/createOutputExcel_004.R")
#######################################################
### Read in the data
#######################################################
getwd()
...
createExcel(lm.loglin$coefficients, lm.lin$coefficients, lm.quad$coefficients, lm.cub$coefficients, glm.lin$coefficients, glm.loglin$coefficients, thetaValues,length(v))
