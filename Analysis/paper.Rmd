...
We were also able to replicate the supply and production functions with a 95% confidence interval band for GLM log-linear model as seen in Figure @\ref(fig:glm-production-func-confidence-band) and the plots are similar to the plots produced in the original paper.
