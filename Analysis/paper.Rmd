...
The r(v) function replicated using bayesian regression is similear to the one estimated in the original paper using OL based Linear Regression. The original paper produced a mean of 0.192999, -0.001682 and 0.000012 and standard deviation of 0.014704, 0.014704 and 0.000005 for V, V^2 and V^3 coeffiecients respectively. The replicated bayesian model produced a mean of 0.192481,-0.001661 and 0.000012, and standard deviation of 0.014845, 0.000579 and 9 5.0e-06 respectively. this proves that the replicated bayesian model produced outputs similar to the original paper.
